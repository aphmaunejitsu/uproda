...
GRANT SELECT,UPDATE,INSERT,DELETE ON uproda.* TO 'updater'@'%'  WITH GRANT OPTION;;
CREATE USER 'reader'@'%' IDENTIFIED BY '9Ol.,ki8';
GRANT SELECT ON uproda.* TO 'reader'@'%'  WITH GRANT OPTION;;
CREATE USER 'maintenance'@'%' IDENTIFIED BY '8ik,.lO9';
GRANT ALL ON uproda.* TO 'maintenance'@'%'  WITH GRANT OPTION;;
