...
;#
;# *****ATTENTION*******
;#  このファイルは Utashiroさんの作られた日本語漢字コード変換ライブラリ
;#  jcode.plの一部機能を削り、imgboard.comのCGIに必要な機能だけを残したものです。
;#  imgboard.com(http://imgboard.com)で配布しているCGI
;#  専用であり、メモリ使用量を節約するためにSJISコードへの変換のみと機能は
;#  非常に限定されていますので、その他のCGIや各種用途にはまったく使えません。
;#  再配布する場合は、オリジナルの最新版を下記URLで入手してください。
;# ftp://ftp.iij.ad.jp/pub/IIJ/dist/utashiro/perl/
;#
;# 2014/12/23	update for Perl5.12 upper version warning taisaku by imgboard.com
;# 2001/07/08	ogo@ta2.so-net.ne.jp
;#
;# PERL4 INTERFACE:
;#
...
sub z2h_euc {
    local(*s, $n) = @_;
# perl 5.12 upper version warning taisaku by imgboard.com 2014.12
