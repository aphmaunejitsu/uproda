<div class="container">
  <div class='section image' >
    <div class="row image-box" style="">
			<div class="nine columns">
	  	<a href="<?php echo $src ?>" target="_blank">
    	  <img class='u-max-full-width image-detail' src="<?php echo $src; ?>">
	  	</a>
			</div>
			<div class="three columns" style="text-align:left">
			  <ul>
			  <?php if ( ! empty(\Arr::get($image, 'comment', null))): ?><li><?php echo \Arr::get($image, 'comment', null);?></li> <?php endif; ?>
		...
		<div class="row">
  	  <input type='text' class='u-full-width' value='<?php echo $src;?>'>
		</div>
  </div>
</div>
